...
public class studentDash extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if( dbc.insertData("INSERT INTO tbl_students (fname,lname,course,section,violation,sanction,type)"
            + "VALUES('"+bee_fn.getText()+"','"+bee_ln.getText()+"','"+bee_course.getSelectedItem()+"','"+bee_section.getText()+"','"+bee_violation.getText()+"','"+bee_sanction.getText()+"','"+bee_type.getSelectedItem()+"')"))
    {
    ...
    private javax.swing.JTextField bee_fn;
    private javax.swing.JTextField bee_ln;
    private javax.swing.JTextField bee_sanction;
    private javax.swing.JTextField bee_section;
